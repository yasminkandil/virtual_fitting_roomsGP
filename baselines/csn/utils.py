...
def config_logging(comment="xz"):
    ...
    # Get current executing script name
    import __main__, os
    exe_fname=os.path.basename(__main__)
...
def prepare_dataloaders(root_dir="E:/cs (Senior) Semester 1/gp/fashion_compatibility_mcn-master/data/images/images", data_dir="E:/cs (Senior) Semester 1/gp/fashion_compatibility_mcn-master/data", batch_size=16, img_size=224, use_mean_img=True, neg_samples=True, collate_fn=collate_fn):
