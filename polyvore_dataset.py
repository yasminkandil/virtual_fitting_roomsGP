...
class CategoryDataset(Dataset):
    ...
    """
    def __init__(self,
                 root_dir="E:/cs (Senior) Semester 1/gp/fashion_compatibility_mcn-master/data/images/images",
                 data_file='train_no_dup_with_category_3more_name.json',
                 data_dir="E:/cs (Senior) Semester 1/gp/fashion_compatibility_mcn-master/data/",
                 transform=None,
                 use_mean_img=True,
                 neg_samples=True):
