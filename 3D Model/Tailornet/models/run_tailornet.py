...
def run_tailornet(uniqueId,garmentClass,genderr):
    gender = genderr
    ...
    for i, (theta, beta, gamma) in enumerate(zip(thetas, betas, gammas)):
        ...
        body.write_obj('E:/GP/fitmoi_mob_app/assets/'+"body_"+uniqueId+".obj")
        
        pred_gar.write_obj("meshes/"+uniqueId+"/"+garmentClass+"_"+uniqueId+".obj")
        pred_gar.write_obj('E:/GP/fitmoi_mob_app/assets/'+garmentClass+"_"+uniqueId+".obj")
        
        writeee("meshes/"+uniqueId+"/"+garmentClass+"_"+uniqueId+".obj","E:/GP/fitmoi_mob_app/assets/"+garmentClass+"_"+uniqueId+".mtl",garmentClass+"_"+uniqueId + ".jpg")
