...
def show_rela_diagnosis(relation, select, cmap=plt.cm.Blues):
    ...
    plt.tight_layout()
    # plt.show()
    plt.savefig("fitmoi_diagnosis.pdf")
    print("Save diagnosis result to fitmoi_diagnosis.pdf")
...
if __name__ == "__main__":
    ...
    model.load_state_dict(torch.load("E:/cs (Senior) Semester 1/gp/fashion_compatibility_mcn-master/mcn/model_train_relation_vse_type_cond_scales.pth"))
    model.eval()
