...
parser.add_argument('--model_path', type=str, default="E:/cs (Senior) Semester 1/gp/fashion_compatibility_mcn-master/mcn/model_train_relation_vse_type_cond_scales.pth")
