...
from TailorNet_master.smpl_lib.serialization import backwards_compatibility_replacements, load_model
import scipy.sparse as sp
from TailorNet_master.global_var import SMPL_PATH_NEUTRAL, SMPL_PATH_MALE, SMPL_PATH_FEMALE
...
class SmplPaths:
    ...
    @staticmethod
    def get_vt_ft(path):
        vt, ft = pkl.load(open(path, 'rb'), encoding='latin1')
        return vt, ft

    @staticmethod
    def get_vt_ft_hres(path):
        vt, ft = SmplPaths.get_vt_ft(path)
