...
def prepare_dataloaders(root_dir="E:/cs (Senior) Semester 1/gp/fashion_compatibility_mcn-master/data/images/images", data_dir="E:/cs (Senior) Semester 1/gp/fashion_compatibility_mcn-master/data/", batch_size=1, img_size=224, use_mean_img=True, neg_samples=True, num_workers=1, collate_fn=collate_fn):
